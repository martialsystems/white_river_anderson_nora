...
from upq.errors import FetchError  # noqa: E402
from upq.pipeline import run_live  # noqa: E402
...
def main() -> int:
    ...
    print({"tau_star": report["tau_star"], "verdict": report["verdict"], "skill": report["skill"]})
